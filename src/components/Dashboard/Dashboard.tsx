...
function Home() {
  ...
  return (
    <div className='home-sec'>
      ...
      <table>
        <tr>
          <th className='d-align'><input type="checkbox" /></th>
          <th>Listing Name</th>
          <th>Area</th>
          <th>Floors</th>
          <th>Facing</th>
        ...
        <tr>
          <td className='d-align'><input type="checkbox" /></td>
          ...
          <td>2nd</td>
          <td>south</td>
          <td className="furnish" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Unfinished">Unfurnis...</td>
          <td className="type ">
          ...
          <td className="Links">
            <div className="link-wrap">
              <EditIcon className='g-bg link-icon'/> 
              <DoneIcon className='g-bg link-icon'/>
              <CloseIcon className='g-bg link-icon'/>
              <DeleteOutlineIcon className='o-bg link-icon'/>
            </div>
          </td>
        </tr>
        <tr>
          ...
          <td>Ground</td>
          <td>East</td>
          <td className="furnish" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Semi-furnished">Semi-fur...</td>
          <td className="type ">
            <div className="lease">
              Lease
            </div>
        ...
        <tr>
          ...
          <td>1st</td>
          <td>East</td>
          <td className='furnish' data-bs-toggle="tooltip" data-bs-placement="bottom" title="Fully Furnished">Fully Fur... </td>
          <td className="type ">
            <div className="sale">
               Sale
            </div>
