...
//     formState.ownerDetails.contact.phone1.trim()
//   );
//   setNested(
//     payload,
//     "owner.contact.email",
//     formState.ownerDetails.contact.email?.trim() ?? ""
//   );
...
//   // area
//   setNested(payload, "area.totalArea", `${formState.location.area?.totalArea ?? ""} sqft`);
//   setNested(payload, "area.builtUpArea", `${formState.location.area?.builtUpArea ?? ""} sqft`);
//   setNested(payload, "area.carpetArea", `${formState.location.area?.carpetArea ?? ""} sqft`);
//   setNested(payload, "area.lenght", `${formState.location.area}`)
//   // floors
...
//   const [plotType, setPlotType] = useState("Shop");
