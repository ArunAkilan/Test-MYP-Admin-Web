...
const PlotView = () => {
  ...
  const [property, setProperty] = useState<PlotPropertyResponse | null>(null);
  ...
  const statusActionMap: Record<string, StatusActionInterface> = {
    "0": { status: "0", label: "Rejected", route: "/plot?tab=deleted" },
    "1": { status: "1", label: "Approved", route: "/plot" },
    "2": { status: "2", label: "Deleted", route: "/plot?tab=deleted" },
    "3": { status: "3", label: "Sold Out", route: "/plot?tab=deleted" },
    "4": { status: "4", label: "Leased Out", route: "/plot?tab=deleted" },
    "5": { status: "5", label: "Rented Out", route: "/plot?tab=deleted" },
  };
          ...
          <div className="row gap-4 data-detail-row">
            {property?.property?.facility?.washRoom !== undefined && (
              <div className="col-md-2 row-individual-data">
                <p>WASHROOM</p>
                <span>
                  <img src={Icon_Cleaning} alt="Washroom" />
            ...
            {property?.property?.facility?.tilesOnFloor !== undefined && (
              <div className="col-md-2 row-individual-data">
                <p>TILES ON FLOOR</p>
                <span>
                  <img src={Icon_restroom} alt="Tiles" />
            ...
            {property?.property?.facility?.readyToOccupy !== undefined && (
              <div className="col-md-2 row-individual-data">
                ...
                <span>
                  ...
                  {property.property.facility.readyToOccupy ? "Available" : "Not Available"}
                </span>
              </div>
            )}
          </div>
