      ...
      {(property?.property?.area?.totalArea ||
        ...
        <section className="midDetails">
          ...
          <div className="row gap-4 data-detail-row">
            ...
            {property?.property?.area?.builtUpArea && Number(property.property.area.builtUpArea) > 0 && (
              <div className="col-md-2 row-individual-data">
                <p>BUILTUP AREA</p>
                <span>
                  <img src={SqrtImage} alt="dimension" />
                  {property.property.area.builtUpArea} sqft
                </span>
              </div>
            )}

            {property?.property?.area?.carpetArea && Number(property.property.area.carpetArea) > 0 && (
              <div className="col-md-2 row-individual-data">
                <p>CARPET AREA</p>
                <span>
                  <img src={SqrtImage} alt="dimension" />
                  {property.property.area.carpetArea} sqft
                </span>
              </div>
            )}
